...
- **技能里程碑 v2 + 廣度**:全 23 技能各 **≥2 節點**(48 節點;薄技能廣度 pass 補齊),達門檻**二選一**永久銘刻(潛行 25「隱遁之術」為唯一**單一 perk 自動授予**退化節點)+ 持久 fortify 加成層(skill/attr/resist)+ 功能槓桿(武器/法術控場、戰場自修、重甲反震、逃命、解陷保底…);反 min-max、守刺客紅線
