...
python3 tests/run_all.py                 # 51 測試模組,不需 pytest,須全綠
...
- **技能里程碑 v2 + 廣度**:全 23 技能各 **≥2 節點**(47 節點;薄技能廣度 pass 補齊),達門檻**二選一**永久銘刻 + 持久 fortify 加成層(skill/attr/resist)+ 功能槓桿(武器/法術控場、戰場自修、重甲反震、逃命、解陷保底…);反 min-max、守刺客紅線
