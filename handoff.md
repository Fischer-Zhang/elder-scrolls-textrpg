...
> 狼人後續可再加:完整 perk 進程樹(餵食解鎖能力)、具名希爾辛神器(獵者之戒)、野外主動變身(目前限戰鬥語境)、獸形在城衛兵實戰圍捕(目前 shunning-light)、howl 咆哮恐懼 power、月相影響變身。
