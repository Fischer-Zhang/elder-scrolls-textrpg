...
- **後期內容:戴德拉親王神殿線(R45;一次一位親王、任務做深)**:野外/城鎮祭壇「供奉祈願」接親王試煉 → 深線結局得**永久誓福**(通用 `boons` 層 data-driven,可同時持有多位親王 → 封頂角色的後期收集軸)或**神器**(分支道德抉擇)。已做 4 位:**阿祖拉「黑星」**(晨風海岸·法師·淨化得晨昏之佑誓福 vs 墮化得黑星護符)、**莫拉格巴爾「恐怖之屋」**(晨風莫拉格瑪·戰士近戰·臣服得莫拉格巴爾之鎚〔吸生命鈍器〕vs 反抗得不屈之心誓福)、**海爾辛「血月狩獵」**(瓦倫森林·遊俠/輕甲·狩成得獵者之佑誓福 vs 奪皮得救主之皮〔輕甲魔抗神器〕)、**波耶西亞「陰謀者試煉」**(天際佛克瑞斯·重甲/反傷·試煉得烏木甲〔荊棘反傷神器〕vs 拒血得弒逆之志誓福)、**克拉維克斯·瓦爾「言靈之犬」**(高岩風暴港·**社交/口才軸**·獻祭得克拉維克斯面具〔helmet·fortify 口才神器〕vs 守諾得言靈之佑誓福);各配新 d5 solo boss/地城,跨五省鋪點、覆蓋 法/戰近/遊俠/重甲反傷/**社交** build。誓福守刺客紅線(無 sneak/武傷)→ sim byte-identical;**加下一位親王=純 JSON**(引擎已就緒)
