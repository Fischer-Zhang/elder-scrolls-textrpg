...
- **roadmap(未做,已評估)**:批 A 手機右緣裁切(戰鬥血量值/角色卡屬性值,`min-width:0` 收尾)、戰鬥玩家魔力條、buff/debuff 標籤分色、對比 AA、創角 build 數值 chips、地圖/傳奇分組。
